...
internals.properties.prototype.parsePropertyMetadata = function(property, name, parent, joiObj) {
  ...
  if (this.settings.xProperties === true) {
    ...
    const examplesObj = Hoek.reach(joiObj, '$_terms.examples');
    const exampleObj = Hoek.reach(examplesObj, '0');
    /* $lab:coverage:off$ */
    // exampleObj.value != null will coerce undefined and null
    property.examples = examplesObj.map(exampleObj => exampleObj.value != null ? exampleObj.value : exampleObj);
